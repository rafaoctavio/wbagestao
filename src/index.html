...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <a href="index.html" class="logo mr-auto"><img src="img/logo-softwareetecnologia-caixabaixa.png" alt="" class="img-fluid"></a>
      ...
      <a href="#sobrenos" class="get-started-btn scrollto">Veja Como Funciona</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Seu sucesso é o nosso sucesso!</h1>
          <h2>Gerencie toda sua empresa de forma fácil, prática e segura.</h2>
          <div class="d-lg-flex">
            <a href="#about" class="btn-get-started scrollto">Fale Conosco <i class="fab fa-whatsapp"></i></a>
            <a href="https://www.youtube.com/watch?v=HbWx1hXhZgw&feature=youtu.be" class="venobox btn-watch-video" data-vbtype="video" data-autoplay="true"> Conheça nosso trabalho <i class="icofont-play-alt-2"></i></a>
          </div>
        </div>
 ...
 <section id="counts" class="counts">
  <div class="container">
    ...
    <section id="sobrenos" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-6">
            <p>
              A WBAGestão é uma software house de sistema de ERP, desenvolvido para os mais diversos setores do mercado brasileiro.
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> Nossos softwares são customizáveis e otimizados.</li>
              <li><i class="ri-check-double-line"></i> Funcionalidades sejam desenvolvidas para conversar de maneira integrada</li>
              <li><i class="ri-check-double-line"></i> Maior aderência ao modelo de negócio de cada cliente</li>
            </ul>
          </div>
      ...
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
            ...
            <div class="content">
              <h3>Prático, Rápido e <strong>Seguro!</strong></h3>
              <p>
                Ajudamos você nas rotinas do dia a dia, através de sistemas que vão auxiliar aomar decisões mais assertivas.
              </p>
            </div>
    ...
    <section id="funcionalidades" class="skills">
      <div class="container" data-aos="fade-up">
    ...
    </section><!-- End Funcionalidades Section -->

    <!-- ======= Serviços Section ======= -->
    <section id="funcionalidades" class="services section-bg">
      <div class="container" data-aos="fade-up">
    ...
    <!-- ======= Segmentos Section ======= -->
    <section id="segmentos" class="portfolio">
      <div class="container" data-aos="fade-up">
    ...
    <!-- ======= Blog Section ======= -->
    <section id="blog" class="pricing section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="200">
            <div class="box">
              <h2>Blog Title</h2>
              <h5>03/01/2020</h5>
              <h4><img src="./img/team/blog.png" alt="" srcset="" width="100px" height="auto"></h4>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor, nobis! Quibusdam autem quisquam vero sequi, ...</p>
              <a href="#" class="buy-btn">Continuar Lendo</a>
            </div>
          </div>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          <div class="col-lg-9 text-center text-lg-left">
            <h3>Nosso blog</h3>
            <p> Em nosso blog você acompanha notícias sobre negócios, marketing e as últimas novidades sobre nossa empresa.</p>
          </div>
          <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle" href="#">Visite nosso Blog</a>
          </div>
        </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <img src="img/logo-softwareetecnologia-caixabaixa.png" alt="" class="img-fluid"/>
            <p>
              A108 Adam Street <br>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <div class="social-links mt-3">
              <a href="https://api.whatsapp.com/send/?phone=5511997086769&text=Ol%C3%A1%2C+gostaria+de+falar+com+um+consultor.&app_absent=0" class="whatsapp"><i class="bx bxl-whatsapp"></i></a>
              <a href="https://www.facebook.com/wbagestao" class="facebook"><i class="bx bxl-facebook"></i></a>
              <a href="https://www.instagram.com/wbagestao/" class="instagram"><i class="bx bxl-instagram"></i></a>
              <a href="https://www.youtube.com/channel/UC0MYB3301U8DpykbF33HCCw" class="youtube"><i class="bx bxl-youtube"></i></a>
              <a href="linkedin.com/company/wbagestaosoftwareetecnologia/" class="linkedin"><i class="bx bxl-linkedin"></i></a>
            </div>
          </div>
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>WBAGestão</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        
        Designed by Rafael Carvalho<a href="https://rafaoctavio.github.io/"></a>
      </div>
    </div>
  </footer><!-- End Footer -->
